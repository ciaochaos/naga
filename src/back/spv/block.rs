            ...
            match *statement {
                ...
                crate::Statement::Atomic {
                    ...
                    if let crate::AtomicFunction::Exchange { compare: Some(cmp) } = *fun {
                        ...
                        let equal_instruction = Instruction::binary(
                        ...
                        block.body.push(ace_instruction);
                        block.body.push(equal_instruction);
                    } else {
